...
<body style="background-image:url(https://tse1.mm.bing.net/th?id=OIP.JWqoBUwYixel8IA1m46BbAHaEK&pid=Api&P=0);background-size: cover;margin-top: 150px;">
  <center>
  
  <fieldset style="width:500px;height: 250px;">
  <legend style="color: black;font-size: 24px" >Admin Login</legend>
